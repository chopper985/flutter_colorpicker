...
class RGBWithRedColorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Gradient gradientH = LinearGradient(
      colors: [
        Color.fromRGBO(color.r.round(), 255, 0, 1.0),
        Color.fromRGBO(color.r.round(), 255, 255, 1.0),
      ],
    );
    final Gradient gradientV = LinearGradient(
      ...
      colors: [
        Color.fromRGBO(color.r.round(), 255, 255, 1.0),
        Color.fromRGBO(color.r.round(), 0, 255, 1.0),
      ],
    );
    canvas.drawRect(rect, Paint()..shader = gradientH.createShader(rect));
    canvas.drawRect(
    ...
    canvas.drawCircle(
      Offset(size.width * color.b.round() / 255,
          size.height * (1 - color.g.round() / 255)),
      size.height * 0.04,
      Paint()
        ..color = pointerColor ??
...
class RGBWithGreenColorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Gradient gradientH = LinearGradient(
      colors: [
        Color.fromRGBO(255, color.g.round(), 0, 1.0),
        Color.fromRGBO(255, color.g.round(), 255, 1.0),
      ],
    );
    final Gradient gradientV = LinearGradient(
      begin: Alignment.topCenter,
      ...
      colors: [
        Color.fromRGBO(255, color.g.round(), 255, 1.0),
        Color.fromRGBO(0, color.g.round(), 255, 1.0),
      ],
    );
    canvas.drawRect(rect, Paint()..shader = gradientH.createShader(rect));
    canvas.drawRect(
    ...
    canvas.drawCircle(
      Offset(size.width * color.b.round() / 255,
          size.height * (1 - color.r.round() / 255)),
      size.height * 0.04,
      Paint()
        ..color = pointerColor ??
            (useWhiteForeground(color) ? Colors.white : Colors.black)
...
class RGBWithBlueColorPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Gradient gradientH = LinearGradient(
      colors: [
        Color.fromRGBO(0, 255, color.b.round(), 1.0),
        Color.fromRGBO(255, 255, color.b.round(), 1.0),
      ],
    );
    final Gradient gradientV = LinearGradient(
      begin: Alignment.topCenter,
      ...
      colors: [
        Color.fromRGBO(255, 255, color.b.round(), 1.0),
        Color.fromRGBO(255, 0, color.b.round(), 1.0),
      ],
    );
    canvas.drawRect(rect, Paint()..shader = gradientH.createShader(rect));
    canvas.drawRect(
    ...
    canvas.drawCircle(
      Offset(size.width * color.r.round() / 255,
          size.height * (1 - color.g.round() / 255)),
      size.height * 0.04,
      Paint()
        ..color = pointerColor ??
...
class _ColorPickerLabelState extends State<ColorPickerLabel> {
  ...
  List<String> colorValue(HSVColor hsvColor, ColorLabelType colorLabelType) {
    if (colorLabelType == ColorLabelType.hex) {
      ...
      return [
        color.r.round().toRadixString(16).toUpperCase().padLeft(2, '0'),
        color.g.round().toRadixString(16).toUpperCase().padLeft(2, '0'),
        color.b.round().toRadixString(16).toUpperCase().padLeft(2, '0'),
        color.a.round().toRadixString(16).toUpperCase().padLeft(2, '0'),
      ];
    } else if (colorLabelType == ColorLabelType.rgb) {
      final Color color = hsvColor.toColor();
      return [
        color.r.round().toString(),
        color.g.round().toString(),
    ...
    return LayoutBuilder(builder: (BuildContext context, BoxConstraints box) {
      ...
      switch (trackType) {
        ...
        case TrackType.red:
          ...
          break;
        case TrackType.green:
          thumbOffset += (box.maxWidth - 30.0) * hsvColor.toColor().g / 0xff;
          thumbColor = hsvColor.toColor().withValues(alpha: 1.0);
          break;
        case TrackType.blue:
